...
// Pins the stacking-context escape for the promote-to-admin modal. Rendered
// in place, it sat inside AdminLayout's `<main class="animate-fade-in">` — a
...
vi.mock('../../features/people/peopleApi', () => ({
  peopleApi: { promoteAdmin: vi.fn() },
}));
...
describe('admins promote modal portal contract', () => {
  it('portals the dialog to document.body with a full-cover overlay', async () => {
    ...
    const dialog = screen.getByRole('dialog', { name: 'Promote to admin' });
