...
Neither RPC exists on the baseline yet: ``update_complaint`` and
``add_complaint_comment`` were defined in ``0013_complaint_events.sql``, which is
quarantined in ``supabase/migrations/legacy-preauth/`` awaiting a rebuild.
"""
